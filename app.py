...
# channel_secret='c77ff91cfb6c14ef2dd5dcef2bf3d555'
# channel_access_token='pKgbbk3r8QFYnUgpfhI6T/UhBi95i/GR19GVN1OZTIKvfXzdOociNwjr+qCSBqWPlz+grCbZCK7J8mvTYBbi+8yZJmMJop0QSDMUdXXkYKhpyWYLa7dQoEvvZOWqU25olyFZO8bXFFB9ze+AJlha9QdB04t89/1O/w1cDnyilFU='
...
def handle_message(event):
    with ApiClient(configuration) as api_client:
        ...
        if user_msg in faq:
            ...
            bot_msg = TextMessage(text=f"現金買入:{buy}\n現金賣出:{sell}")
